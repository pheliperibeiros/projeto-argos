...
const DEFAULT_DB = {
    casos: [] as Caso[],
    investigados: [] as Investigado[],
    caso_investigado: [] as CasoInvestigado[],
    cautelares: [] as Cautelar[],
    enderecos: [] as Endereco[],
    socios_empresa: [] as SocioEmpresa[],
    dashboard_historico_casos: [] as HistoricoCaso[],
    profiles: [
